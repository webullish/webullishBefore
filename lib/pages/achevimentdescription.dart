...
class achevimentdetails extends StatefulWidget {
  final achevimentModel character;

  const achevimentdetails({Key? key, required this.character})
      : super(key: key);
...
class _CharacterDetailScreenState extends State<achevimentdetails> {
  @override
